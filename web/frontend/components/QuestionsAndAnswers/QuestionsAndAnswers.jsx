...
const QuestionsAndAnswers = ({ updateData, FAQs }) => {
    ...
    const handleDelete = (itemIndex) => {
        const newQuestionsAndAnswers = state.FAQs.filter((prevState, index) => index !== itemIndex);
    ...
    return (
        <>
            {isModalWindow && modalWindowNameToOpen === "AddNewQuestionsAndAnswers" && (
                <AddNewQuestionsAndAnswers setIsModalwindow={setIsModalWindow} questionsAndAnswersList={state.FAQs} setChange={handleChange}/>
            )}
            {isModalWindow && modalWindowNameToOpen === "EditQuestionAndanswer" && (
                <EditQuestionAndAnswer setIsModalwindow={setIsModalWindow} itemIndex={itemIndex} questionsAndAnswersList={state.FAQs} setChange={handleChange}/>
            )}
